...
testModo.add_argument('-utm', '--use_time_mode', help='Max number of secs for time mode or maximum number of inputs for number of inputs mode', action="store_true")
testModo.add_argument('-mv', '--max_value', help='Max number of secs for time mode or maximum number of inputs for number of inputs mode')
...
if args_list['use_time_mode']==True:
    ...
    limiteTime=args_list['max_value']   # tempo maximo
else:
    print (tes)
    ...
    limiteInputs=args_list['max_value']   # imputs maximo
